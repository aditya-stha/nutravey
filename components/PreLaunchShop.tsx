...
export default function PreLaunchShop() {
  ...
  return (
    ...
    >
            ...
            <div className="border border-[var(--color-rule)] p-10 md:p-12 relative overflow-hidden bg-[var(--color-surface-card)]" style={{ minHeight: "400px", borderRadius: "var(--radius-canvas)" }}>
              <AnimatePresence mode="wait">
                {selectedItem !== "bundle" && activeProduct ? (
                  ...
                  >
                    <div
                      className="prelaunch-visual canvas-hover flex-shrink-0"
                  ...
                  >
                    ...
                    <div className="prelaunch-stack canvas-hover flex-shrink-0" aria-hidden="true">
                      {products.map((p) => (
                        <div
                          key={p.id}
      ...
      <style>{`
        /* ── Product visual canvas — glow comes from the global .canvas-glow ── */
        .prelaunch-visual {
          position: relative;
          width: 192px;
          aspect-ratio: 4 / 5;
        ...
        @media (prefers-reduced-motion: reduce) {
          .prelaunch-squircle,          .prelaunch-visual:hover .prelaunch-squircle { transform: none; }
        }
      `}</style>
    </div>
  );
